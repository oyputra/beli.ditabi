    ...
    <div class="flex justify-center">
        ...
        <div class="shadow rounded bg-white px-4 pt-6 pb-8 lg:w-8/12 w-full">
            <div class="flex justify-between items-center mb-4">
                ...
                <a href="{{ route('dashboard.changedetail') }}" class="bg-blue-700 text-white px-3 py-2 rounded-3xl">Change</a>
            </div>
            <div class="space-y-3 flex flex-col px-5 mt-10">
                <div class="flex items-center">
                    ...
                    <p class="text-lg capitalize">{{ $user->name }}</p>
                </div>
                <div class="flex items-center">
                    <div class="w-2/12">
                    ...
                    <p class="text-lg lowercase">{{ $user->email }}</p>
                </div>
            </div>
        </div>
        <!-- single card end -->
