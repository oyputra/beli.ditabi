            ...
            <div class="col-md-6 col-12">
                <div class="card">
                    <div class="card-header flex justify-between">
                        <h3 class="text-xl">Change account</h2>
                    </div>
                                ...
                                <div class="form-body">
                                    <div class="space-y-3">
                                        ...
                                        <div class="flex justify-end mt-3 space-x-2">
                                            <a href="{{ route('db-admin.detail') }}" class="btn btn-secondary rounded-pill focus:ring-0 hover:shadow-xl animation">Cancel</a>
                                            <button type="submit" class="btn btn-primary bg-primary rounded-pill focus:ring-0 hover:shadow-xl animation">
                                                Update
                                            </button>
                                        </div>
                                    </div>
