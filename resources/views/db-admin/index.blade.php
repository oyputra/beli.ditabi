                ...
                <div class="col-6 col-lg-3 col-md-6">
                    <div class="card">
                        <div class="card-body px-3 py-4-5">
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="bg-primary px-4 py-3 flex justify-center text-white rounded-md">
                ...
                <div class="col-6 col-lg-3 col-md-6">
                    <div class="card">
                        <div class="card-body px-3 py-4-5">
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="bg-success px-4 py-3 flex justify-center text-white rounded-md">
                ...
                <div class="col-6 col-lg-3 col-md-6">
                    <div class="card">
                        <div class="card-body px-3 py-4-5">
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="bg-warning px-4 py-3 flex justify-center text-white rounded-md">
                ...
                <div class="col-6 col-lg-3 col-md-6">
                    <div class="card">
                        <div class="card-body px-3 py-4-5">
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="bg-danger px-4 py-3 flex justify-center text-white rounded-md">
                                        <i class="bi bi-wallet"></i>
                                    </div>
                                </div>
                                <div class="col-md-8">
                                    <h6 class="text-muted font-semibold">Omzet</h6>
                                    <h6 class="font-extrabold mb-0">100.000.000</h6>
                                </div>
                            </div>
                        </div>
                    </div>
